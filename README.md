...
# git clone https://github.com/YOUR\_USERNAME/linebot-cloudrun.git
...
# LINE\_CHANNEL\_SECRET=your\_channel\_secret\_here

# LINE\_CHANNEL\_ACCESS\_TOKEN=your\_access\_token\_here
...
# LINE\_CHANNEL\_SECRET=你的Channel\_Secret

# LINE\_CHANNEL\_ACCESS\_TOKEN=你的Access\_Token
...
# gcloud projects create YOUR\_PROJECT\_ID --name="LINE Bot Project"
...
# &nbsp; --set-env-vars LINE\_CHANNEL\_SECRET=你的Channel\_Secret,LINE\_CHANNEL\_ACCESS\_TOKEN=你的Access\_Token
...
# &nbsp;  https://你的Cloud\_Run\_URL/callback
...
# | `LINE\_CHANNEL\_SECRET` | LINE Channel 金鑰 | ✅ |

# | `LINE\_CHANNEL\_ACCESS\_TOKEN` | LINE Channel 存取權杖 | ✅ |
...
# LINE\_CHANNEL\_SECRET=your\_secret\_here

# LINE\_CHANNEL\_ACCESS\_TOKEN=your\_token\_here
...
# &nbsp; --set-env-vars LINE\_CHANNEL\_SECRET=xxx,LINE\_CHANNEL\_ACCESS\_TOKEN=yyy
...
# echo -n "your\_secret" | gcloud secrets create line-channel-secret --data-file=-
...
# &nbsp; --set-secrets LINE\_CHANNEL\_SECRET=line-channel-secret:latest
...
# 編輯 `app.py` 的 `handle\_message` 函數：
...
# &nbsp;   user\_message = event.message.text

# &nbsp;   

# &nbsp;   # 根據關鍵字回覆

# &nbsp;   if "你好" in user\_message:

# &nbsp;       reply = "你好！很高興認識你！"

# &nbsp;   elif "天氣" in user\_message:

# &nbsp;       reply = "今天天氣很好喔！"

# &nbsp;   else:

# &nbsp;       reply = f"你說：{user\_message}"
...
# &nbsp;       original\_content\_url='https://example.com/image.jpg',

# &nbsp;       preview\_image\_url='https://example.com/preview.jpg'
...
# buttons\_template = ButtonsTemplate(
...
# &nbsp;   TemplateSendMessage(alt\_text='選單', template=buttons\_template)
...
# &nbsp; --set-env-vars LINE\_CHANNEL\_SECRET=新的值
...
# &nbsp;         project\_id: ${{ secrets.GCP\_PROJECT\_ID }}
